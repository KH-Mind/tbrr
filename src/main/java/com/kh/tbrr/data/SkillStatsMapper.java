 ...
 * 
 * 各技能は以下のステータスを持つ:
 * - might (強靭): 身体の強さ、フィジカル
 * - insight (聡明): 賢さ、頭脳（INT+WIS）
 * - finesse (機敏): 器用さ、身のこなし
 * - presence (風格): 人を動かす力、カリスマ
...
public class SkillStatsMapper {
    ...
    static {
        ...
        SKILL_STATS.put("筋力", CombatStats.of(4, 0, 1, 1, 0));
        SKILL_STATS.put("敏捷力", CombatStats.of(1, 1, 3, 1, 0));
        SKILL_STATS.put("耐久力", CombatStats.of(3, 0, 1, 2, 0));
        SKILL_STATS.put("知力", CombatStats.of(0, 4, 1, 1, 0));
        SKILL_STATS.put("判断力", CombatStats.of(0, 3, 2, 1, 0));
        SKILL_STATS.put("魅力", CombatStats.of(0, 1, 1, 4, 0));

        // その他の技能 - 各合計6点
        // might, insight, finesse, presence, sensuality
        SKILL_STATS.put("運動", CombatStats.of(3, 0, 2, 1, 0));
        SKILL_STATS.put("軽業", CombatStats.of(1, 0, 4, 1, 0));
        SKILL_STATS.put("隠密", CombatStats.of(0, 2, 3, 1, 0));
        ...
        SKILL_STATS.put("話術", CombatStats.of(0, 2, 1, 3, 0));
        SKILL_STATS.put("解錠術", CombatStats.of(0, 1, 4, 1, 0));
        SKILL_STATS.put("料理", CombatStats.of(1, 2, 2, 1, 0));
        SKILL_STATS.put("経世", CombatStats.of(0, 2, 1, 3, 0));
        SKILL_STATS.put("薬識", CombatStats.of(0, 4, 1, 1, 0));
        SKILL_STATS.put("機巧", CombatStats.of(0, 2, 3, 1, 0));
    }
