...
public class TraitData {
    ...
    public String getSystemicEffect() {
        return systemicEffect;
    }

    public List<String> getOffHandFreeTagConditions() {
        return offHandFreeTagConditions;
    }

    public int getOffHandHitPenalty() {
        return offHandHitPenalty;
    }

    public double getOffHandDamageMultiplier() {
        return offHandDamageMultiplier;
    }
    ...
    public void setSystemicEffect(String systemicEffect) {
        this.systemicEffect = systemicEffect;
    }

    public void setOffHandFreeTagConditions(List<String> offHandFreeTagConditions) {
        this.offHandFreeTagConditions = offHandFreeTagConditions;
    }

    public void setOffHandHitPenalty(int offHandHitPenalty) {
        this.offHandHitPenalty = offHandHitPenalty;
    }

    public void setOffHandDamageMultiplier(double offHandDamageMultiplier) {
        this.offHandDamageMultiplier = offHandDamageMultiplier;
    }
    ...
    public void setGrantedAbilities(List<String> grantedAbilities) {
    ...
    public void setHitChanceBonus(int hitChanceBonus) {
